...
#   11   [2]    Valid accuracy: 0.285047    Test accuracy: 0.268901

model_folder = '../saved_models/cnn_model/'
model_name = model_folder + 'cnn_model.ckpt'
model_text = model_folder + 'cnn_summary.txt'
