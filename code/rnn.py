...
#   54   Valid accuracy: 0.27726    Test accuracy: 0.27514

model_folder = '../saved_models/rnn_model/'
model_name = model_folder + 'rnn_model.ckpt'
model_text = model_folder + 'rnn_summary.txt'
