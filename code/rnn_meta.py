...
#   17       Valid accuracy: 0.301402       Test accuracy: 0.298519

model_folder = '../saved_models/rnn_meta_model/'
model_name = model_folder + 'rnn_meta_model.ckpt'
model_text = model_folder + 'rnn_meta_summary.txt'
...
# full flat layer
full_flat_size = 2 * rnn_size + n_filters_meta
full_flat_layer = tf.concat([final_state, dropout_layer_meta], axis=1)                            # [batch_size x 2 * rnn_size + n_filters_meta]
