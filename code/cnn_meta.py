...
#   23                       Valid accuracy: 0.30374        Test accuracy: 0.29306

model_folder = '../saved_models/cnn_meta_model/'
model_name = model_folder + 'cnn_meta_model.ckpt'
model_text = model_folder + 'cnn_meta_summary.txt'
...
for index, filter_size in enumerate(filter_sizes):
    W_conv = tf.get_variable('W_conv_{}'.format(index), shape=[filter_size, embedding_size, n_channels, n_filters], initializer=tf.contrib.layers.xavier_initializer())
